""" Cimpl (Carleton IMage Processing Library).
...
release = "Cimpl 1.00 Release Candidate 1"
...
def choose_save_filename(initial=''):
    ...
    path = tkFileDialog.asksaveasfilename(filetypes=IMAGE_FILE_TYPES,
                                          initialfile=initial,
...
def choose_file():
    ...
    path = tkFileDialog.askopenfilename(filetypes=IMAGE_FILE_TYPES)
